...
figure8<-function(){
  ...
  AddiVortes_Algorithm_Plot(Y[TrainSet],X[TrainSet,],50,2000,200,6,0.85,3,0.8,3,25,f(X[TestSet,]),X[TestSet,],IntialSigma = "Naive", p=100)
  ...
  AddiVortes_Algorithm_Plot(Y[TrainSet],X[TrainSet,],50,2000,200,6,0.85,3,0.8,3,25,f(X[TestSet,]),X[TestSet,],IntialSigma = "Naive", p=1000)
